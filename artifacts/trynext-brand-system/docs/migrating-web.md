...
`artifacts/trynext-brand-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/trynext-brand-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/trynext-brand-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/trynext-brand-system/hooks/use-toast`
