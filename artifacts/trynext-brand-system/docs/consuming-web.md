...
Read `artifacts/trynext-brand-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/trynext-brand-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/trynext-brand-system/styles.css";
```
...
`node_modules/@workspace/trynext-brand-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/trynext-brand-system/components/ui/button";
import { cn } from "@workspace/trynext-brand-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/trynext-brand-system/hooks/use-toast";
```
...
`@workspace/trynext-brand-system/components/ui/button`. Run the app's typecheck
