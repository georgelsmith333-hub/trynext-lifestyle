...
workspace package (`@workspace/trynext-brand-system`): other artifacts depend
...
`@workspace/trynext-brand-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/trynext-brand-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/trynext-brand-system` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/trynext-brand-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/trynext-brand-system/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/trynext-brand-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/trynext-brand-system/docs/migrating-expo.md`
