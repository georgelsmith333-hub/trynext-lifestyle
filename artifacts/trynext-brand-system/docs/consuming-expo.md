...
Read `artifacts/trynext-brand-system/docs/AGENTS.md` first. React Native does
...
`artifacts/trynext-brand-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/trynext-brand-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/trynext-brand-system/lib/native-theme";
import { useColors } from "@workspace/trynext-brand-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/trynext-brand-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/trynext-brand-system/components/native/badge";
import { Button } from "@workspace/trynext-brand-system/components/native/button";
import { Card } from "@workspace/trynext-brand-system/components/native/card";
```
...
Import and render
`@workspace/trynext-brand-system/components/native/button`, then run Expo
