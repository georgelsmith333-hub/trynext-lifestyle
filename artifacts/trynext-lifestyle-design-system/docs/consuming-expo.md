# Consuming Trynext Lifestyle Design System in Expo apps

Read `artifacts/trynext-lifestyle-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/trynext-lifestyle-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/trynext-lifestyle-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/trynext-lifestyle-design-system/lib/native-theme";
import { useColors } from "@workspace/trynext-lifestyle-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/trynext-lifestyle-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/trynext-lifestyle-design-system/components/native/badge";
import { Button } from "@workspace/trynext-lifestyle-design-system/components/native/button";
import { Card } from "@workspace/trynext-lifestyle-design-system/components/native/card";
```
...
Import and render
`@workspace/trynext-lifestyle-design-system/components/native/button`, then run Expo
