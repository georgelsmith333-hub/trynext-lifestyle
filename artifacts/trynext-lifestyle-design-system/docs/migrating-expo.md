# Migrating Expo UI to Trynext Lifestyle Design System

Read `artifacts/trynext-lifestyle-design-system/docs/AGENTS.md` and
`artifacts/trynext-lifestyle-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/trynext-lifestyle-design-system/lib/native-theme` and
  `@workspace/trynext-lifestyle-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/trynext-lifestyle-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/trynext-lifestyle-design-system` and retains only
