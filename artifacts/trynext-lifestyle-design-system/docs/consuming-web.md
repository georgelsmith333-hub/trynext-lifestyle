# Consuming Trynext Lifestyle Design System in web apps

Read `artifacts/trynext-lifestyle-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/trynext-lifestyle-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/trynext-lifestyle-design-system/styles.css";
```
...
`node_modules/@workspace/trynext-lifestyle-design-system/src/components` to `content`.
...
import { cn } from "@workspace/trynext-lifestyle-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/trynext-lifestyle-design-system/hooks/use-toast";
```
...
`@workspace/trynext-lifestyle-design-system/components/ui/button`. Run the app's typecheck
