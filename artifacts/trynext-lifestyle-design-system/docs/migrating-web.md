# Migrating web UI to Trynext Lifestyle Design System

Read `artifacts/trynext-lifestyle-design-system/docs/AGENTS.md` and
`artifacts/trynext-lifestyle-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/trynext-lifestyle-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/trynext-lifestyle-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/trynext-lifestyle-design-system/hooks/use-toast`
