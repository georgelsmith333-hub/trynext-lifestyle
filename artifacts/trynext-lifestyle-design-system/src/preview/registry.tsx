...
export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overview',
  description: 'The visual foundations and product patterns that shape every Trynext surface.',
  Page: OverviewPage,
};
    ...
    entries: [
      {
        id: 'brand-language',
        name: 'Brand language',
        description: 'Trynext personality, trust cues, hierarchy, and usage guidance.',
        Page: BrandPage,
      },
    ],
  },
