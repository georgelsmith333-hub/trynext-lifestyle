# Migrating web UI to Trynext Atelier Commerce

Read `artifacts/trynext-atelier-commerce/docs/AGENTS.md` and
`artifacts/trynext-atelier-commerce/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/trynext-atelier-commerce/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/trynext-atelier-commerce/lib/utils`
- `@/hooks/use-toast` → `@workspace/trynext-atelier-commerce/hooks/use-toast`
