# Consuming Trynext Atelier Commerce in Expo apps

Read `artifacts/trynext-atelier-commerce/docs/AGENTS.md` first. React Native does
...
`artifacts/trynext-atelier-commerce/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/trynext-atelier-commerce/tokens";
...
```tsx
import { nativeTheme } from "@workspace/trynext-atelier-commerce/lib/native-theme";
import { useColors } from "@workspace/trynext-atelier-commerce/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/trynext-atelier-commerce/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/trynext-atelier-commerce/components/native/badge";
import { Button } from "@workspace/trynext-atelier-commerce/components/native/button";
import { Card } from "@workspace/trynext-atelier-commerce/components/native/card";
```
...
Import and render
`@workspace/trynext-atelier-commerce/components/native/button`, then run Expo
