# Consuming Trynext Atelier Commerce in web apps

Read `artifacts/trynext-atelier-commerce/docs/AGENTS.md` first. This guide covers
...
`artifacts/trynext-atelier-commerce/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/trynext-atelier-commerce/styles.css";
```
...
`node_modules/@workspace/trynext-atelier-commerce/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/trynext-atelier-commerce/components/ui/button";
import { cn } from "@workspace/trynext-atelier-commerce/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/trynext-atelier-commerce/hooks/use-toast";
```
...
`@workspace/trynext-atelier-commerce/components/ui/button`. Run the app's typecheck
