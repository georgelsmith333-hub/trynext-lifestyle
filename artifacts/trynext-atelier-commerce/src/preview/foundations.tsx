    ...
    <div className="space-y-4">
      ...
      <section className="rounded-xl border bg-card p-5 text-card-foreground">
        ...
        <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
          A premium POD workflow should make the real product, the buyer
          outcome, and the next confident action visible at every step.
        </p>
        <div className="mt-4">
          <Guidelines
            items={[
              { kind: 'do', text: 'Use warm-white surfaces so reviewed product edges and soft shadows stay legible.' },
              { kind: 'do', text: 'Use orange for the one next action and sage for trust, readiness, and verified feedback.' },
              { kind: 'dont', text: 'Hide important listing, mockup, or pricing decisions behind a vague automation step.' },
            ]}
          />
        </div>
      </section>
