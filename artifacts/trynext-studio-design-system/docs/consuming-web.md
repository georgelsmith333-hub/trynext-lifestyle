# Consuming Trynext Studio Design System in web apps

Read `artifacts/trynext-studio-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/trynext-studio-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/trynext-studio-design-system/styles.css";
```
...
`node_modules/@workspace/trynext-studio-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/trynext-studio-design-system/components/ui/button";
import { cn } from "@workspace/trynext-studio-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/trynext-studio-design-system/hooks/use-toast";
```
...
`@workspace/trynext-studio-design-system/components/ui/button`. Run the app's typecheck
