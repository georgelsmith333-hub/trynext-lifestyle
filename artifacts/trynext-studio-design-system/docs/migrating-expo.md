# Migrating Expo UI to Trynext Studio Design System

Read `artifacts/trynext-studio-design-system/docs/AGENTS.md` and
`artifacts/trynext-studio-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/trynext-studio-design-system/lib/native-theme` and
  `@workspace/trynext-studio-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/trynext-studio-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/trynext-studio-design-system` and retains only
