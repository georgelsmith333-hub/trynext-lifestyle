# Migrating web UI to Trynext Studio Design System

Read `artifacts/trynext-studio-design-system/docs/AGENTS.md` and
`artifacts/trynext-studio-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/trynext-studio-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/trynext-studio-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/trynext-studio-design-system/hooks/use-toast`
