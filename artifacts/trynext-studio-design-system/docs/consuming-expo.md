# Consuming Trynext Studio Design System in Expo apps

Read `artifacts/trynext-studio-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/trynext-studio-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/trynext-studio-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/trynext-studio-design-system/lib/native-theme";
import { useColors } from "@workspace/trynext-studio-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/trynext-studio-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/trynext-studio-design-system/components/native/badge";
import { Button } from "@workspace/trynext-studio-design-system/components/native/button";
import { Card } from "@workspace/trynext-studio-design-system/components/native/card";
```
...
Import and render
`@workspace/trynext-studio-design-system/components/native/button`, then run Expo
