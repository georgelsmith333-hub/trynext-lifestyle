...
export const DESIGN_SYSTEM = {
  title: 'Trynext Studio Design System',
  description:
    'A photo-first Trynext system for custom product design: warm retail surfaces, clear editing controls, Bangladesh-green trust cues, and honest product mockups.',
} as const;
