...
const STACK_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "CORS", desc: "Credential-based origin whitelisting (trynext.shop + Expo mobile)" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Cloudflare Pages", desc: "Global CDN & static hosting for the storefront (trynext.shop)" },
      { name: "Cloudflare R2", desc: "S3-compatible object storage for product & upload images" },
      { name: "Cloudflare DNS", desc: "Cloudflare Pages hosting for trynext.shop" },
