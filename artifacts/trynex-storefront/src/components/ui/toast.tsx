...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 right-0 z-[9999] flex max-h-screen w-full flex-col p-4 pb-6 pointer-events-none [&>*]:pointer-events-auto sm:top-auto sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
